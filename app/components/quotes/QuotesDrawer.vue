    ...
    <template #body>
      <div class="space-y-6 p-6">
                  ...
                  <template #item="{ item }">
                    ...
                    >
                      ...
                      <UButton
                        ...
                        size="sm"
                        class="opacity-0 group-hover/item:opacity-100 transition-opacity h-9 w-9"
                        @click="
                          onDeleteDriver({
              ...
              <div class="grid grid-cols-2 sm:grid-cols-3 gap-5">
                ...
                >
                  <UInput
                    ...
                    size="lg"
                    :disabled="isRestrictedEdit"
                    @blur="item.unitPrice = normalizeMoney(item.unitPrice || 0)"
                  />
                </UFormField>
        ...
        >
          ...
          <UFormField label="Mensagem de Validade (PDF destaque)">
            <UTextarea
              v-model="form.validityMessage"
              placeholder="Ex: Orçamento válido por 3 dias úteis..."
              :rows="2"
              class="w-full"
            />
          </UFormField>
