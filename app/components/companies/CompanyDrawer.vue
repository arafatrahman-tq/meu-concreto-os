          ...
          <div>
            ...
            >
              ...
              >
                ...
                >
                  <div
                    class="w-6 h-6 rounded-md bg-zinc-200 dark:bg-zinc-700 flex items-center justify-center shrink-0"
                  >
                    <span
                      class="text-xs font-black text-zinc-600 dark:text-zinc-300"
                    >
