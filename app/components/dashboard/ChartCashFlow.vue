...
const barHeight = (val: number) =>
  Math.max(4, (val / props.metrics.chartMax.value) * 140);
</script>
    ...
    >
      <template #header>
        ...
        >
          ...
          <div
            class="flex flex-wrap items-center gap-3 text-[10px] font-bold text-zinc-400 uppercase tracking-wider pl-12 sm:pl-0"
          >
            <span
