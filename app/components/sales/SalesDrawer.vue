            ...
            <div class="col-span-full space-y-3">
              ...
              >
                ...
                <UButton
                  ...
                  :label="localUseDeliveryAddress ? 'Cancelar' : 'Alterar entrega'"
                  @click="localUseDeliveryAddress = !localUseDeliveryAddress"
                />
              </div>

              <UFormField
                :label="customerRegisteredAddress ? 'Endereço de Entrega (diferente)' : 'Endereço de Entrega'"
                :class="{ hidden: customerRegisteredAddress && !localUseDeliveryAddress }"
              >
                <UInput
                  ...
                  <template #item="{ item }">
                    <div class="flex items-center justify-between w-full group/item">
                      ...
                      <UButton
                        ...
                        @click="onDeleteDriver($event, { id: item.value, name: item.label })"
                      />
                    </div>
                  </template>
                  ...
                  <template #item="{ item }">
                    <div class="flex items-center justify-between w-full group/item">
                      ...
                      <UButton
                        ...
                        size="xs"
                        class="opacity-0 group-hover/item:opacity-100 transition-opacity"
                        @click="onDeletePumper($event, { id: item.value, name: item.label })"
                      />
                    </div>
                  </template>
                  <template #empty="{ searchTerm }">
