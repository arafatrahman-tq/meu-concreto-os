...
<template>
  <div class="p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
    ...
    <UCard>
      ...
      <template #header>
        ...
        >
          <div class="flex items-center gap-3">
            ...
            <div>
              <h3
                class="font-black text-zinc-900 dark:text-white leading-tight"
              >
                Lista de Transações
              </h3>
          ...
          <div class="flex items-center gap-2 flex-wrap justify-end">
            ...
            <USelect
              ...
              class="w-40"
            />
            <UInput v-model="dateStart" type="date" size="sm" class="w-36" />
            <UInput v-model="dateEnd" type="date" size="sm" class="w-36" />
            <UTooltip text="Limpar datas" :disabled="!dateStart && !dateEnd">
              <UButton
      ...
      <!-- Loading skeleton -->
      <div v-if="loadingTx" class="space-y-3 py-2">
      ...
      >
        <UIcon name="i-heroicons-arrows-right-left" class="w-12 h-12 mb-3" />
        <p class="text-sm font-bold">Nenhuma transação encontrada</p>
            ...
            >
              ...
              <td class="px-4 py-3.5">
                <div class="flex flex-col gap-0.5">
                  ...
                  <span v-if="t.sale" class="text-xs text-zinc-400">
                    <UIcon
