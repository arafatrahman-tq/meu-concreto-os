...
<template>
  <div class="p-8 space-y-8 min-h-full">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 pb-4">
      ...
      <template v-else>
        <DashboardRecentTransactions :transactions="metrics.recentTransactions.value" class="h-full" />
        <DashboardRecentSales :sales="metrics.recentSales.value" class="h-full" />
