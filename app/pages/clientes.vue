    ...
    >
        ...
        <table class="w-full text-sm">
          <thead>
            <tr class="bg-zinc-50/50 dark:bg-zinc-800/20">
              ...
              <th
                class="text-center px-4 py-4 text-[10px] font-black uppercase tracking-widest text-zinc-400 hidden lg:table-cell"
              >
                Orçamentos
              </th>
              <th
              ...
              <th
                class="text-right px-4 py-4 text-[10px] font-black uppercase tracking-widest text-zinc-400 hidden xl:table-cell"
              >
                Última Atividade
              </th>
              <th class="px-6 py-4" />
      ...
      >
        <div class="flex items-center justify-between">
          ...
          >
            {{ filteredCustomers.length }} clientes · página {{ page }} de
            {{ totalPages }}
          </p>
          <div class="flex items-center gap-2">
            <UButton
    ...
    >
      ...
      <template #body>
        ...
        >
          ...
          <!-- Contact info -->
          <div
            class="rounded-3xl bg-zinc-50 dark:bg-zinc-800/20 p-6 border border-zinc-200/50 dark:border-zinc-700/30 space-y-3"
          >
            <h4
          ...
          <div class="grid grid-cols-3 gap-3">
            <div
              class="rounded-2xl bg-white dark:bg-zinc-900 ring-1 ring-zinc-200 dark:ring-zinc-800 p-4 text-center"
            >
              <p class="text-2xl font-black text-zinc-900 dark:text-white">
                {{ selectedCustomer.quotesCount }}
              </p>
              <p
                class="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400 mt-1"
              >
                Orçamentos
              </p>
            </div>
            ...
            <div
              class="rounded-2xl bg-green-50 dark:bg-green-500/10 ring-1 ring-green-100 dark:ring-green-500/20 p-4 text-center"
            >
              <p
              ...
              <p
                class="text-[10px] font-black uppercase tracking-[0.2em] text-green-500/70 mt-1"
              >
                Total Gasto
              </p>
            </div>
