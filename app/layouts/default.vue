...
<template>
  <UApp>
    ...
    <div
      class="flex h-screen w-full overflow-hidden bg-zinc-50 dark:bg-zinc-950"
    >
      <!--
      ...
      >
        ...
        >
          ...
          <div
            v-else
            class="w-10 h-10 rounded-xl bg-primary-500 flex items-center justify-center shrink-0 shadow-lg shadow-primary-500/30 relative"
          >
            <div
        ...
        <div
          class="flex-1 flex flex-col overflow-y-auto overflow-x-hidden custom-scrollbar"
        >
        ...
        <!-- Footer da Sidebar -->
        <div
          class="shrink-0 border-t border-zinc-100 dark:border-zinc-900 bg-zinc-50/50 dark:bg-zinc-900/30 p-3 overflow-hidden"
        >
      ...
      >
        <template #body>
          <div class="flex flex-col h-full bg-white dark:bg-zinc-950">
            <div
              class="p-4 border-b border-zinc-100 dark:border-zinc-900 flex justify-between items-center shrink-0"
            >
              <AppLogo />
              <UButton
            ...
            <div
              class="p-4 border-t border-zinc-100 dark:border-zinc-800 shrink-0"
            >
              <UserDropdown />
            </div>
          </div>
      ...
      <div class="flex-1 flex flex-col min-w-0">
        <!-- Header Navbar -->
        <header
          class="flex items-center justify-between px-4 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-xl border-zinc-200 dark:border-zinc-800 border-b h-20 shrink-0 z-20"
        >
          <!-- Left -->
            ...
            <div class="flex items-center gap-2">
              ...
              >
                <UButton
                  ...
                  variant="ghost"
                  size="sm"
                  class="hover:bg-primary-500/10 hover:text-green-500 transition-colors rounded-xl h-9 w-9"
