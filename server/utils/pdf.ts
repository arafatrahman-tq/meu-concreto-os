...
import { db } from './db'
import { companies, sellers } from '../database/schema'
...
export async function generateDocumentPDF(
  ...
  doc.text('MEU CONCRETO', pageWidth / 2, pageHeight / 2, {
    align: 'center',
    angle: 45
  })
  ...
  // Simplified "Anvil" icon (White dots or small shapes)
  ...
  if (data.seller) {
    ...
    if (data.seller.commissionRate !== undefined && data.seller.commissionRate !== null) {
